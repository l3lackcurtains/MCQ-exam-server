            ...
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        ...
                        _context.prev = 11;
                        _context.next = 14;
                        return _comment2.default.paginate(findFilter, { page: pageNo, limit: limitNo, sort: sort, select: select });

                    case 14:
                        data = _context.sent;

                        if (!data) res.json({ success: false, message: "Error fetching comment." });
                        res.json({ success: true, message: "Comments successfully fetched.", data: data });
                        _context.next = 22;
                        break;
 ...
 * *************************************
*/
router.get('/comment/:id', function () {
            ...
            while (1) {
                switch (_context2.prev = _context2.next) {
                    case 0:
                        ...
                        _context2.prev = 2;
                        _context2.next = 5;
                        return _comment2.default.findOne({ _id: req.params.id }, select);

                    case 5:
                        data = _context2.sent;

                        if (!data) res.json({ success: false, message: 'Comment id is invalid.' });
                        res.json({ success: true, message: "Comment successfully fetched.", data: data });
                        _context2.next = 13;
                        break;
 ...
 * *************************************
*/
router.get('/comment/uid/:id', function () {
            ...
            while (1) {
                switch (_context3.prev = _context3.next) {
                    case 0:
                        ...
                        _context3.prev = 2;
                        _context3.next = 5;
                        return _comment2.default.findOne({ uid: req.params.id }, select);
        ...
        return _regenerator2.default.wrap(function _callee4$(_context4) {
            while (1) {
                switch (_context4.prev = _context4.next) {
                    case 0:
                        _context4.prev = 0;
                        comment = (0, _comment2.default)(req.body);
                        _context4.next = 4;
                        return comment.save();
 ...
 * *************************************
*/
router.put('/comment/:id', function () {
            ...
            while (1) {
                switch (_context5.prev = _context5.next) {
                    case 0:
                        _context5.prev = 0;
                        _context5.next = 3;
                        return _comment2.default.findOne({ _id: req.params.id });

                    case 3:
                        comment = _context5.sent;

                        if (!comment) res.json({ success: false, message: 'Comment id is invalid.' });
                        comment.set((0, _extends3.default)({}, req.body));
                        _context5.next = 8;
                        return comment.save();

                    case 8:
                        updateComment = _context5.sent;
 ...
 * *************************************
*/
router.delete('/comment/:id', function () {
            ...
            while (1) {
                switch (_context6.prev = _context6.next) {
                    case 0:
                        _context6.prev = 0;
                        _context6.next = 3;
                        return _comment2.default.findByIdAndRemove(req.params.id);

                    case 3:
                        removedComment = _context6.sent;
