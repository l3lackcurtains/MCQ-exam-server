            ...
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        ...
                        _context.prev = 11;
                        _context.next = 14;
                        return _study2.default.paginate(findFilter, { page: pageNo, limit: limitNo, sort: sort, select: select });

                    case 14:
                        data = _context.sent;

                        if (!data) res.json({ success: false, message: "Error fetching study." });
                        res.json({ success: true, message: "Studies successfully fetched.", data: data });
                        _context.next = 22;
                        break;
            ...
            while (1) {
                switch (_context2.prev = _context2.next) {
                    case 0:
                        ...
                        _context2.prev = 2;
                        _context2.next = 5;
                        return _study2.default.findOne({ _id: req.params.id }, select);

                    case 5:
                        data = _context2.sent;

                        if (!data) res.json({ success: false, message: 'Study id is invalid.' });
                        res.json({ success: true, message: "Study successfully fetched.", data: data });
                        _context2.next = 13;
                        break;
        ...
        return _regenerator2.default.wrap(function _callee3$(_context3) {
            while (1) {
                switch (_context3.prev = _context3.next) {
                    case 0:
                        _context3.prev = 0;
                        study = (0, _study2.default)(req.body);
                        _context3.next = 4;
                        return study.save();

                    case 4:
                        newStudy = _context3.sent;
 ...
 * *************************************
*/
router.put('/study/:id', function () {
    var _ref4 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee4(req, res) {
        var study, updateStudy;
            ...
            while (1) {
                switch (_context4.prev = _context4.next) {
                    case 0:
                        _context4.prev = 0;
                        _context4.next = 3;
                        return _study2.default.findOne({ _id: req.params.id });

                    case 3:
                        study = _context4.sent;

                        if (!study) res.json({ success: false, message: 'Study id is invalid.' });
                        study.set((0, _extends3.default)({}, req.body));
                        _context4.next = 8;
                        return study.save();

                    case 8:
                        updateStudy = _context4.sent;
 ...
 * *************************************
*/
router.delete('/study/:id', function () {
            ...
            while (1) {
                switch (_context5.prev = _context5.next) {
                    case 0:
                        _context5.prev = 0;
                        _context5.next = 3;
                        return _study2.default.findByIdAndRemove(req.params.id);

                    case 3:
                        removedStudy = _context5.sent;
